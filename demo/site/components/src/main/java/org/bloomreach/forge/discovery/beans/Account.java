...
@HippoEssentialsGenerated(internalName = "demo:account")
@Node(jcrType = "demo:account")
public class Account extends HippoCompound {

    public static final String TYPE = "demo:type";
    public static final String LINK = "demo:link";

    @HippoEssentialsGenerated(internalName = "demo:type")
