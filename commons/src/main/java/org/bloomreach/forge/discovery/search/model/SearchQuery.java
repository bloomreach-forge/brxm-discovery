...
public record SearchQuery(
    ...
    public SearchQuery(String query, int page, int pageSize, String sort,
        ...
        this(query, page, pageSize, sort, filters, brUid2, refUrl, url, null, catalogName, statsFields, null, null, Map.of(), null);
    }
    ...
    public SearchQuery(String query, int page, int pageSize, String sort,
        ...
        this(query, page, pageSize, sort, filters, brUid2, refUrl, url, null, catalogName, statsFields, segment, efq, Map.of(), null);
    }
    ...
    public SearchQuery(String query, int page, int pageSize, String sort,
                       ...
                       String brUid2, String refUrl, String url,
                       String catalogName) {
        this(query, page, pageSize, sort, filters, brUid2, refUrl, url, null, catalogName, List.of(), null, null, Map.of(), null);
    }
    ...
    public SearchQuery(String query, int page, int pageSize, String sort,
                       Map<String, List<String>> filters,
                       String brUid2, String refUrl, String url) {
        this(query, page, pageSize, sort, filters, brUid2, refUrl, url, null, null, List.of(), null, null, Map.of(), null);
    }

    public SearchQuery withStatsFields(List<String> statsFields) {
        return new SearchQuery(query, page, pageSize, sort, filters, brUid2, refUrl, url, origRefUrl, catalogName, statsFields, segment, efq, rangeFilters, fields);
    }
