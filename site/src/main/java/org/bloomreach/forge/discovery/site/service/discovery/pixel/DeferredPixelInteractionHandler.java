 ...
 */
public final class DeferredPixelInteractionHandler {
    ...
    public DeferredPixelInteractionHandler(DiscoveryPixelService pixelService) {
        this.pixelService = pixelService;
    }

    public void handleSearchInteraction(HstRequest request, DiscoveryRuntimeContext runtimeContext,
                                        SearchQuery query) {
        ...
        if (EVENT_SEARCH_SUBMIT.equals(event)) {
            if (markInteractionProcessed(request, EVENT_SEARCH_SUBMIT + ":" + query.query())) {
                pixelService.fire(DeferredPixelEvent.searchSubmit(
        ...
        if (EVENT_SUGGEST_CLICK.equals(event)) {
            ...
            if (markInteractionProcessed(request, eventKey)) {
                pixelService.fire(DeferredPixelEvent.suggestClick(
                                "search", runtimeContext.pageTitle(), runtimeContext.pageUrl(),
                                runtimeContext.refUrl(), runtimeContext.origRefUrl(),
    ...
    public void handleProductInteraction(HstRequest request, DiscoveryRuntimeContext runtimeContext,
        ...
        pixelService.fire(DeferredPixelEvent.widgetClick(
