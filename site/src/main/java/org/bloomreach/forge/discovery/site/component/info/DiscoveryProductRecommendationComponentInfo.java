...
@FieldGroupList({
    ...
    @FieldGroup(value = {"productUrlParam"}, titleKey = "advanced.group")
})
public interface DiscoveryProductRecommendationComponentInfo {

    @Parameter(name = "document", displayName = "Recommendation Document")
    @JcrPath(
        pickerConfiguration = "cms-pickers/documents-only",
        pickerSelectableNodeTypes = {"brxdis:productRecommendationDocument"},
