...
class DeferredPixelInteractionHandlerTest {
    ...
    void handleSearchInteraction_searchSubmit_firesSearchSubmitEvent() {
        ...
        ArgumentCaptor<DeferredPixelEvent> captor = ArgumentCaptor.forClass(DeferredPixelEvent.class);
        verify(pixelService).fireDeferredEvent(captor.capture(), any(), any(), any(), any());
        DeferredPixelEvent event = captor.getValue();
    ...
    void handleProductInteraction_widgetClick_nullProduct_itemIdIsNull() {
        ...
        ArgumentCaptor<DeferredPixelEvent> captor = ArgumentCaptor.forClass(DeferredPixelEvent.class);
        verify(pixelService).fireDeferredEvent(captor.capture(), any(), any(), any(), any());
        assertNull(captor.getValue().itemId());
    }
