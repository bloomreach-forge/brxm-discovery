...
class QueryParamParserTest {
    ...
    void toSearchQuery_trackingParams_threadedThrough() {
        ...
        SearchQuery query = QueryParamParser.toSearchQuery(params, settings,
    ...
    void toSearchQuery_componentPageSize_usedWhenUrlParamAbsent() {
        ...
        SearchQuery query = QueryParamParser.toSearchQuery(params, settings, 24, null, null, null, null);
    ...
    void toSearchQuery_componentSort_usedWhenUrlParamAbsent() {
        ...
        SearchQuery query = QueryParamParser.toSearchQuery(params, settings, 0, "price asc", null, null, null);
    ...
    void toSearchQuery_zeroPageSizeFallback_fallsThroughToConfigDefault() {
        ...
        SearchQuery query = QueryParamParser.toSearchQuery(params, settings, 0, null, null, null, null);
    ...
    void toSearchQuery_blankSortFallback_fallsThroughToConfigDefault() {
        ...
        SearchQuery query = QueryParamParser.toSearchQuery(params, settings, 0, "", null, null, null);
    ...
    void toCategoryQuery_withCategoryId_mapsCorrectly() {
        ...
        CategoryQuery query = QueryParamParser.toCategoryQuery("electronics", params, settings, null, null, null);
    ...
    void toCategoryQuery_missingPagination_usesDefaults() {
        ...
        CategoryQuery query = QueryParamParser.toCategoryQuery("shoes", params, settings, null, null, null);
    ...
    void toCategoryQuery_trackingParams_threadedThrough() {
        ...
        CategoryQuery query = QueryParamParser.toCategoryQuery("apparel", params, settings,
    ...
    void toCategoryQuery_componentPageSize_usedWhenUrlParamAbsent() {
        ...
        CategoryQuery query = QueryParamParser.toCategoryQuery("cat-1", params, settings, 24, null, null, null, null);
    ...
    void toCategoryQuery_componentSort_usedWhenUrlParamAbsent() {
        ...
        CategoryQuery query = QueryParamParser.toCategoryQuery("cat-1", params, settings, 0, "price asc", null, null, null);
