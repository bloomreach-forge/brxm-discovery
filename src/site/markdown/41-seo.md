...
URL structure does not affect pixel tracking. The pixel reads identifiers from the `br_data` JavaScript object, not URL parameters. See [50-pixel-tracking.md](50-pixel-tracking.md) for details.
